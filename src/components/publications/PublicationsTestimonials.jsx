...
const PublicationsTestimonials = () => {
  ...
  const testimonials = [
    {
      ...
      content: "The quality of research published through this platform is exceptional. Our latest paper on AI in education received widespread recognition.",
      rating: 5,
      avatar: "👩‍🔬"
    },
    {
      ...
      content: "The publication process is streamlined and efficient. Our research findings reach the right audience quickly and effectively.",
      rating: 5,
      avatar: "👨‍🏫"
    },
    {
      ...
      content: "The peer review process is thorough and constructive. It helped us improve our research methodology significantly.",
      rating: 5,
      avatar: "👩‍💼"
    },
    {
      ...
      content: "The platform's reach to top-tier journals is impressive. Our publications get the visibility they deserve.",
      rating: 5,
      avatar: "👨‍🎓"
    },
    {
      ...
      content: "The collaborative environment fosters innovation. Working with other researchers through this platform has been invaluable.",
      rating: 5,
      avatar: "👩‍🔬"
    }
  ];
    ...
    <section className="py-20 bg-gradient-to-b from-white via-primary/5 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Trusted by{' '}
            <span className="gradient-text">Leading Researchers</span>
          </motion.h2>
          <motion.p
          ...
          >
            Join renowned researchers and academics who publish their groundbreaking work through our platform
          </motion.p>
        </motion.div>
...
export default PublicationsTestimonials;
