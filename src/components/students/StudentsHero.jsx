...
const OfferCard = ({ delay }) => (
  <motion.div
    ...
    whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(0,0,0,0.1)" }}
  >
    <div className="text-xs text-gray-600 font-medium mb-2">Student Special Offer</div>
    <div className="text-gray-900 text-sm font-semibold">
      GET <span className="text-green-500 font-bold text-base">30% OFF</span> on all courses
    </div>
    <div className="text-xs text-gray-500 mt-3 font-medium">Your student discount code:</div>
...
const StudentsHero = () => {
  ...
  return (
    <section id="students-home" className="pt-[150px] md:pt-32 pb-0 md:pb-0 bg-gradient-to-b from-white via-white to-gray-50">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            <div className="absolute -top-4 -right-4 md:top-8 md:right-0 w-56 md:w-64 z-10">
              <StatCard title="Courses completed" value="1,250" delay={0.5} />
            </div>
