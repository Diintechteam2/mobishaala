...
const ShashiKarnaAllCourses = () => {
  const [category, setCategory] = useState('BPSC');
  ...
  const handleBuy = (title) => {
    alert(`Checkout for "${title}" will be launched soon.`);
  };
    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-black text-gray-900">Browse Shashi Karna Classes offerings</h1>
          <p className="text-gray-600 mt-3 max-w-2xl">
            Filter by target exam, language or search specific batches. All enrollments run on Mobishaala infrastructure with secure payments.
          </p>
        </div>
        ...
        {filtered.length === 0 && (
          <div className="text-center text-gray-500 mt-10">No batches match your filters.</div>
        )}
      </main>
      <ShashiKarnaFooter />
    </div>
...
export default ShashiKarnaAllCourses;
