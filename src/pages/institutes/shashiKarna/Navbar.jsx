...
const navLinks = [
  { label: 'All Courses', href: '/institutes/shashi-karna/courses', external: false },
...
const ShashiKarnaNavbar = () => (
  <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      <Link to="/institutes/shashi-karna" className="flex items-center gap-3">
        <img
          src="https://images.unsplash.com/photo-1524593166156-312f362cada0?w=120&auto=format&fit=crop"
          alt="Shashi Karna Classes"
        ...
        <div>
          ...
          <p className="text-lg font-black text-gray-900">BPSC & UPSC Academy</p>
        </div>
      </Link>
...
export default ShashiKarnaNavbar;
