...
const navLinks = [
  { label: 'All Courses', href: '/institutes/examdrishti/courses', external: false },
...
const ExamDrishtiNavbar = () => (
  <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      <Link to="/institutes/examdrishti" className="flex items-center gap-3">
        <img
          src="https://images.unsplash.com/photo-1503602642458-232111445657?w=120&auto=format&fit=crop"
          alt="ExamDrishti"
        ...
        <div>
          ...
          <p className="text-lg font-black text-gray-900">Govt Exam Super App</p>
        </div>
      </Link>
...
export default ExamDrishtiNavbar;
