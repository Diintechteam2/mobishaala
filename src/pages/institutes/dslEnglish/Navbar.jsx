...
const navLinks = [
  { label: 'All Courses', href: '/institutes/dsl-english/courses', external: false },
  { label: 'Experience', href: '#journey', external: true },
  { label: 'Testimonials', href: '#testimonials', external: true },
  { label: 'FAQs', href: '#faqs', external: true },
];

const DslEnglishNavbar = () => (
  <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      <Link to="/institutes/dsl-english" className="flex items-center gap-3">
        <img
          src="https://images.unsplash.com/photo-1504593811423-6dd665756598?w=120&auto=format&fit=crop"
          alt="DSL English"
        ...
        <div>
          ...
          <p className="text-lg font-black text-gray-900">Communication Academy</p>
        </div>
      </Link>
...
export default DslEnglishNavbar;
